...
describe('Test Data Builder', () => {
	...
	describe('Product validation rules', () => {
		it('should return an object error when creating a Product with invalid id', () => {
			...
			const expected = {
				errors: [
					'id: invalid length, current [1] expect ot be between 2 and 20',
				],
				result: false,
			};
		...
		it('should return an object error when creating a Product with invalid price', () => {
			...
			const expected = {
				errors: [
					'price: invalid value, current [2000] expect ot be between 1 and 1000',
				],
				result: false,
			};
		...
		it('should return an object error when creating a Product with invalid category', () => {
			...
			const expected = {
				errors: [
					'category: invalid value, current [mecanic] expect ot be either electronic or organic',
				],
				result: false,
			};
